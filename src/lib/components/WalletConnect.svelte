<script lang="ts">
	import { account, network, walletActions, isChainSupported, getChainName, getChainInfo } from '$lib/stores/walletStore';
	import { Copy, ExternalLink, Wallet, AlertCircle } from '@lucide/svelte';
...
<div class="flex items-center space-x-3">
	...
	{:else}
		...
		<button 
			...
			class="flex items-center space-x-2 px-4 py-2 bg-primary-500 hover:bg-primary-600 text-white rounded-lg font-medium transition-colors shadow-sm hover:shadow-md"
		>
